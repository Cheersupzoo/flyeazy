...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = 'SELECT * FROM "Staff" as u WHERE u."StaffEmail" = \'' . $username . '\' and u."password" = \'' . $password . '\'';
    ...
    if ($testers) {
        ...
        ob_start();
        session_start();
        $_SESSION['valids'] = true;
        foreach ($testers as $tester) {
            $_SESSION['FNames'] = $tester['StaffName'];
            $_SESSION['sid'] = $tester['sid'];
        }
