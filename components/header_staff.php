        ...
        <div class="container">
            <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
                ...
                <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
                    <li><a href="./index.php" class="nav-link px-2 link-secondary"><img style="height: 55px;" src="/flyeazy/flyeazy-logo.png" alt="logo"/><span class="text-white fw-bolder ms-2">STAFF</span></a></li>
...
if (!$valid) {
    echo <<<HTML
                    <li><a href="./signin.php" class="nav-link px-2 link-light">SIGN IN</a></li>
HTML;
}
